        ...
        for (int Ifilt=0; Ifilt < n_filt; Ifilt++) {
            ...
            for (int Ifilt=0; Ifilt<n_filt; Ifilt++) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    //0.5-30 Hz band pass filter, 2nd Order Butterworth: [b, a] = butter(2,[0.5 30.0]/(fs_Hz / 2.0))
                    switch(int(fs_Hz)) {
                        case 125:
                            b = new double[] { 0.267590748748625, 0, -0.535181497497250, 0, 0.267590748748625};
                            a = new double[] {1.0, -2.054030062656001, 1.320768976615665, -0.439496447777746, 0.173452172438264};
                            break;
                        case 200:
                            b = new double[] {0.127623558135966, 0, -0.255247116271933, 0, 0.127623558135966};
                            a = new double[] {1.000000000000000, -2.745024697470440, 2.779275203384997, -1.311698323948364, 0.277577757683566};
                            break;
                        case 250:
                            b = new double[] {0.088826099917877, 0,  -0.177652199835754, 0, 0.088826099917877};
                            a = new double[] {1.000000000000000, -2.983422939561200, 3.326928233369001, -1.697055571917799, 0.353608211181907};
                            break;
                        case 500:
                            b = new double[] {0.027038151622086, 0, -0.054076303244173, 0, 0.027038151622086};
                            a = new double[] {1.000000000000000, -3.479818558341185, 4.552763170902944, -2.665084725112089, 0.592144526459120};
                            break;
                        case 1000:
                            b = new double[] {0.007577051052547, 0, -0.015154102105094, 0, 0.007577051052547};
                            a = new double[] {1.000000000000000, -3.737998486467212, 5.245551135756502, -3.276969262116864, 0.769416922152944};
                            break;
                        case 1600:
                            b = new double[] {0.003098119456794, 0, -0.006196238913588, 0, 0.003098119456794};
                            a = new double[] {1.000000000000000, -3.836049145056307, 5.521019171402715, -3.533855814794493, 0.848885837856357};
                            break;
                        default:
                            println("EEG_Processing: *** ERROR *** Filters can only work at 125Hz, 200Hz, 250 Hz, 1000Hz or 1600Hz");
                            b = new double[] { 1.0 };
